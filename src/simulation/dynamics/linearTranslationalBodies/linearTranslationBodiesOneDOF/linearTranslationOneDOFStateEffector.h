...
private:
    ...
    Eigen::Vector3d r_PcN_N;            //!< [m] position vector of spinning body center of mass Sc relative to the inertial frame origin N
    ...
    Eigen::Vector3d omega_PN_P;         //!< [rad/s] inertial spinning body frame angular velocity vector
